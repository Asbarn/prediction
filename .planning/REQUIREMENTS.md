...
- [x] **INFRA-02**: User sees analysis output as formatted terminal tables with aligned numeric columns and section headers
- [x] **INFRA-03**: User can pass `--output json` to get machine-readable JSON output instead of terminal tables
- [x] **INFRA-04**: User can pass `--by-event` to see all analyses broken down by event_id in addition to aggregate view
