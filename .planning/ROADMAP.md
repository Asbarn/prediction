...
- [ ] **Phase 26: Analysis Infrastructure** - Shared stats module, JSONL data loading, and output formatting for both CLIs
- [ ] **Phase 27: Spread Analytics CLI** - Complete spread-analytics binary with distribution stats, hourly buckets, and venue-pair breakdown
...
| 26. Analysis Infrastructure | 1/2 | In Progress|  | - |
