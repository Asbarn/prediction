...
export class PredictionStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    instance.userData.addCommands(
      ...
      `aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin ${this.account}.dkr.ecr.us-east-1.amazonaws.com`,
      'FSEOF',
      '',
    ...
    instance.userData.addCommands(
      ...
      'services:',
      '  prediction:',
      `    image: ${this.account}.dkr.ecr.us-east-1.amazonaws.com/prediction:latest`,
      '    env_file: .env',
